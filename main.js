...
function createChart(containerId, seriesName, tooltipText, nameTitleY='Y', needTextX=0) {
    ...
    yAxis.renderer.minGridDistance = 100; // Устанавливаем минимальное расстояние между горизонтальными линиями на 1 единицу
...
var data3 = generateyData(Wc, Wa, -10, 10, (x, Wc, Wa) => Math.exp(-x)*Math.exp(-Math.exp(-x)));
